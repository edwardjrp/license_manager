<?php
//Include Common Files @1-3CEDEEBA
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "companies_maint.php");
...
//Include Page implementation @7-42096EFE
include_once(RelativePath . "/companies_maintcontent.php");
//End Include Page implementation

//Initialize Page @1-97E61ED4
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "companies_maint.html";
$BlockToParse = "main";
...
$companies_maintcontent = new clscompanies_maintcontent("", "companies_maintcontent", $MainPage);
$companies_maintcontent->Initialize();
$MainPage->header = & $header;
$MainPage->sidebar = & $sidebar;
$MainPage->ace_settings = & $ace_settings;
$MainPage->footer = & $footer;
$MainPage->meta_head = & $meta_head;
$MainPage->companies_maintcontent = & $companies_maintcontent;
...
//Execute Components @1-D8F1FF99
$header->Operations();
$sidebar->Operations();
$ace_settings->Operations();
$footer->Operations();
$meta_head->Operations();
$companies_maintcontent->Operations();
//End Execute Components

//Go to destination page @1-1D7CD572
if($Redirect)
{
 ...
 unset($meta_head);
 $companies_maintcontent->Class_Terminate();
 unset($companies_maintcontent);
 unset($Tpl);
 exit;
}
//End Go to destination page

//Show Page @1-A6A52535
$header->Show();
$sidebar->Show();
$ace_settings->Show();
$footer->Show();
$meta_head->Show();
$companies_maintcontent->Show();
$Tpl->block_path = "";
