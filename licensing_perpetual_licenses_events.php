...
//licensing_perpetual_licenses_BeforeShow @1-EBD7324E
function licensing_perpetual_licenses_BeforeShow(& $sender)
{
 $licensing_perpetual_licenses_BeforeShow = true;
 $Component = & $sender;
 $Container = & CCGetParentContainer($sender);
 global $licensing_perpetual_licenses; //Compatibility
//End licensing_perpetual_licenses_BeforeShow
...
// -------------------------
 // Write your own code here.
	...
	if (strlen($guid) > 0) {
		...
		$licenses = $products->getPerpetualLicenses($params);
		...
		foreach($allLicenses as $license) {
			...
			$Tpl->parse("license_perpetual_list",true);
		}
...
//Close licensing_perpetual_licenses_BeforeShow @1-973D717F
 return $licensing_perpetual_licenses_BeforeShow;
}
//End Close licensing_perpetual_licenses_BeforeShow
