<?php
//Include Common Files @1-879242D4
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "users_photos.php");
...
//Include Page implementation @9-089F5ACA
include_once(RelativePath . "/users_photoscontent.php");
//End Include Page implementation

//Initialize Page @1-C49D15F9
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "users_photos.html";
$BlockToParse = "main";
...
$users_photoscontent = new clsusers_photoscontent("", "users_photoscontent", $MainPage);
$users_photoscontent->Initialize();
$MainPage->header = & $header;
$MainPage->sidebar = & $sidebar;
$MainPage->ace_settings = & $ace_settings;
$MainPage->footer = & $footer;
$MainPage->meta_head = & $meta_head;
$MainPage->users_photoscontent = & $users_photoscontent;
...
//Execute Components @1-2DA5104A
$header->Operations();
$sidebar->Operations();
$ace_settings->Operations();
$footer->Operations();
$meta_head->Operations();
$users_photoscontent->Operations();
//End Execute Components

//Go to destination page @1-97441EFB
if($Redirect)
{
    ...
    unset($meta_head);
    $users_photoscontent->Class_Terminate();
    unset($users_photoscontent);
    unset($Tpl);
    exit;
}
//End Go to destination page

//Show Page @1-7AA88895
$header->Show();
$sidebar->Show();
$ace_settings->Show();
$footer->Show();
$meta_head->Show();
$users_photoscontent->Show();
$Tpl->block_path = "";
