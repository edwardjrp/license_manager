<?php
//Include Common Files @1-3D2649D3
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "contacts_holidays_maint.php");
...
//Include Page implementation @9-72FA2876
include_once(RelativePath . "/contacts_holidays_maintcontent.php");
//End Include Page implementation

//Initialize Page @1-33EAE072
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "contacts_holidays_maint.html";
$BlockToParse = "main";
...
$contacts_holidays_maintcontent = new clscontacts_holidays_maintcontent("", "contacts_holidays_maintcontent", $MainPage);
$contacts_holidays_maintcontent->Initialize();
$MainPage->header = & $header;
$MainPage->sidebar = & $sidebar;
$MainPage->ace_settings = & $ace_settings;
$MainPage->footer = & $footer;
$MainPage->meta_head = & $meta_head;
$MainPage->contacts_holidays_maintcontent = & $contacts_holidays_maintcontent;
...
//Execute Components @1-562A7EAC
$header->Operations();
$sidebar->Operations();
$ace_settings->Operations();
$footer->Operations();
$meta_head->Operations();
$contacts_holidays_maintcontent->Operations();
//End Execute Components

//Go to destination page @1-C22D9CE2
if($Redirect)
{
 ...
 unset($meta_head);
 $contacts_holidays_maintcontent->Class_Terminate();
 unset($contacts_holidays_maintcontent);
 unset($Tpl);
 exit;
}
//End Go to destination page

//Show Page @1-F710C870
$header->Show();
$sidebar->Show();
$ace_settings->Show();
$footer->Show();
$meta_head->Show();
$contacts_holidays_maintcontent->Show();
$Tpl->block_path = "";
