<?php
//Include Common Files @1-FE653FB2
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "products_suite_maint.php");
...
//Include Page implementation @10-AD6319B1
include_once(RelativePath . "/products_suite_maintcontent.php");
//End Include Page implementation

//Initialize Page @1-84A143F2
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "products_suite_maint.html";
$BlockToParse = "main";
...
$products_suite_maintcontent = new clsproducts_suite_maintcontent("", "products_suite_maintcontent", $MainPage);
$products_suite_maintcontent->Initialize();
$MainPage->header = & $header;
$MainPage->sidebar = & $sidebar;
$MainPage->ace_settings = & $ace_settings;
$MainPage->footer = & $footer;
$MainPage->meta_head = & $meta_head;
$MainPage->products_suite_maintcontent = & $products_suite_maintcontent;
...
//Execute Components @1-8A03A1C9
$header->Operations();
$sidebar->Operations();
$ace_settings->Operations();
$footer->Operations();
$meta_head->Operations();
$products_suite_maintcontent->Operations();
//End Execute Components

//Go to destination page @1-5239E281
if($Redirect)
{
 ...
 unset($meta_head);
 $products_suite_maintcontent->Class_Terminate();
 unset($products_suite_maintcontent);
 unset($Tpl);
 exit;
}
//End Go to destination page

//Show Page @1-B8EC884D
$header->Show();
$sidebar->Show();
$ace_settings->Show();
$footer->Show();
$meta_head->Show();
$products_suite_maintcontent->Show();
$Tpl->block_path = "";
