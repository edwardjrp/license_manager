...
class clsRecordcustomers_maintcontentalm_customers { //alm_customers Class @8-2A29BDB7
...
//Class_Initialize Event @8-F5BA13AD
 function clsRecordcustomers_maintcontentalm_customers($RelativePath, & $Parent)
 {
  ...
  $this->DataSource = new clscustomers_maintcontentalm_customersDataSource($this);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->os_workstations->DataSource->Parameters["expr54"] = "1";
   $this->os_workstations->DataSource->wp = new clsSQLParameters();
   $this->os_workstations->DataSource->wp->AddParameter("1", "expr54", ccsInteger, "", "", $this->os_workstations->DataSource->Parameters["expr54"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->os_servers->DataSource->Parameters["expr52"] = "3";
   $this->os_servers->DataSource->wp = new clsSQLParameters();
   $this->os_servers->DataSource->wp->AddParameter("1", "expr52", ccsInteger, "", "", $this->os_servers->DataSource->Parameters["expr52"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->servers_type->DataSource->Parameters["expr155"] = "4";
   $this->servers_type->DataSource->wp = new clsSQLParameters();
   $this->servers_type->DataSource->wp->AddParameter("1", "expr155", ccsInteger, "", "", $this->servers_type->DataSource->Parameters["expr155"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->mailservers->DataSource->Parameters["expr157"] = "5";
   $this->mailservers->DataSource->wp = new clsSQLParameters();
   $this->mailservers->DataSource->wp->AddParameter("1", "expr157", ccsInteger, "", "", $this->mailservers->DataSource->Parameters["expr157"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->proxyserver->DataSource->Parameters["expr159"] = "6";
   $this->proxyserver->DataSource->wp = new clsSQLParameters();
   $this->proxyserver->DataSource->wp->AddParameter("1", "expr159", ccsInteger, "", "", $this->proxyserver->DataSource->Parameters["expr159"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->content_filter->DataSource->Parameters["expr173"] = "13";
   $this->content_filter->DataSource->wp = new clsSQLParameters();
   $this->content_filter->DataSource->wp->AddParameter("1", "expr173", ccsInteger, "", "", $this->content_filter->DataSource->Parameters["expr173"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->branches_connectivity->DataSource->Parameters["expr163"] = "8";
   $this->branches_connectivity->DataSource->wp = new clsSQLParameters();
   $this->branches_connectivity->DataSource->wp->AddParameter("1", "expr163", ccsInteger, "", "", $this->branches_connectivity->DataSource->Parameters["expr163"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->branches_bandwidth->DataSource->Parameters["expr161"] = "7";
   $this->branches_bandwidth->DataSource->wp = new clsSQLParameters();
   $this->branches_bandwidth->DataSource->wp->AddParameter("1", "expr161", ccsInteger, "", "", $this->branches_bandwidth->DataSource->Parameters["expr161"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->os_workstations_hw->DataSource->Parameters["expr151"] = "2";
   $this->os_workstations_hw->DataSource->wp = new clsSQLParameters();
   $this->os_workstations_hw->DataSource->wp->AddParameter("1", "expr151", ccsInteger, "", "", $this->os_workstations_hw->DataSource->Parameters["expr151"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->os_servers_hw->DataSource->Parameters["expr153"] = "2";
   $this->os_servers_hw->DataSource->wp = new clsSQLParameters();
   $this->os_servers_hw->DataSource->wp->AddParameter("1", "expr153", ccsInteger, "", "", $this->os_servers_hw->DataSource->Parameters["expr153"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->database_security->DataSource->Parameters["expr179"] = "16";
   $this->database_security->DataSource->wp = new clsSQLParameters();
   $this->database_security->DataSource->wp->AddParameter("1", "expr179", ccsInteger, "", "", $this->database_security->DataSource->Parameters["expr179"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->security_events->DataSource->Parameters["expr181"] = "17";
   $this->security_events->DataSource->wp = new clsSQLParameters();
   $this->security_events->DataSource->wp->AddParameter("1", "expr181", ccsInteger, "", "", $this->security_events->DataSource->Parameters["expr181"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->changecontrol->DataSource->Parameters["expr185"] = "19";
   $this->changecontrol->DataSource->wp = new clsSQLParameters();
   $this->changecontrol->DataSource->wp->AddParameter("1", "expr185", ccsInteger, "", "", $this->changecontrol->DataSource->Parameters["expr185"], "", false);
   ...
   $this->contact_workemail = new clsControl(ccsTextBox, "contact_workemail", $CCSLocales->GetText("workemail"), ccsText, "", CCGetRequestParam("contact_workemail", $Method, NULL), $this);
   $this->contact_personalemail = new clsControl(ccsTextBox, "contact_personalemail", $CCSLocales->GetText("personalemail"), ccsText, "", CCGetRequestParam("contact_personalemail", $Method, NULL), $this);
   $this->hidcontact_guid = new clsControl(ccsHidden, "hidcontact_guid", "hidcontact_guid", ccsText, "", CCGetRequestParam("hidcontact_guid", $Method, NULL), $this);
   ...
   $this->contact_jobposition = new clsControl(ccsListBox, "contact_jobposition", $CCSLocales->GetText("contact_jobposition"), ccsText, "", CCGetRequestParam("contact_jobposition", $Method, NULL), $this);
   $this->contact_jobposition->DSType = dsTable;
   $this->contact_jobposition->DataSource = new clsDBdbConnection();
   $this->contact_jobposition->ds = & $this->contact_jobposition->DataSource;
   $this->contact_jobposition->DataSource->SQL = "SELECT * \n" .
"FROM alm_jobpositions {SQL_Where} {SQL_OrderBy}";
   list($this->contact_jobposition->BoundColumn, $this->contact_jobposition->TextColumn, $this->contact_jobposition->DBFormat) = array("id", "jobposition", "");
   $this->contact_phone = new clsControl(ccsTextBox, "contact_phone", $CCSLocales->GetText("phone"), ccsText, "", CCGetRequestParam("contact_phone", $Method, NULL), $this);
   $this->contact_extension = new clsControl(ccsTextBox, "contact_extension", $CCSLocales->GetText("extension"), ccsText, "", CCGetRequestParam("contact_extension", $Method, NULL), $this);
   $this->contact_mobile = new clsControl(ccsTextBox, "contact_mobile", $CCSLocales->GetText("mobile"), ccsText, "", CCGetRequestParam("contact_mobile", $Method, NULL), $this);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->virtualization->DataSource->Parameters["expr192"] = "20";
   $this->virtualization->DataSource->wp = new clsSQLParameters();
   $this->virtualization->DataSource->wp->AddParameter("1", "expr192", ccsInteger, "", "", $this->virtualization->DataSource->Parameters["expr192"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->email_protection->DataSource->Parameters["expr196"] = "21";
   $this->email_protection->DataSource->wp = new clsSQLParameters();
   $this->email_protection->DataSource->wp->AddParameter("1", "expr196", ccsInteger, "", "", $this->email_protection->DataSource->Parameters["expr196"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->vurnerabilities->DataSource->Parameters["expr177"] = "15";
   $this->vurnerabilities->DataSource->wp = new clsSQLParameters();
   $this->vurnerabilities->DataSource->wp->AddParameter("1", "expr177", ccsInteger, "", "", $this->vurnerabilities->DataSource->Parameters["expr177"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->firewalls->DataSource->Parameters["expr169"] = "11";
   $this->firewalls->DataSource->wp = new clsSQLParameters();
   $this->firewalls->DataSource->wp->AddParameter("1", "expr169", ccsInteger, "", "", $this->firewalls->DataSource->Parameters["expr169"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->backupsystem->DataSource->Parameters["expr167"] = "10";
   $this->backupsystem->DataSource->wp = new clsSQLParameters();
   $this->backupsystem->DataSource->wp->AddParameter("1", "expr167", ccsInteger, "", "", $this->backupsystem->DataSource->Parameters["expr167"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->antivirus->DataSource->Parameters["expr165"] = "9";
   $this->antivirus->DataSource->wp = new clsSQLParameters();
   $this->antivirus->DataSource->wp->AddParameter("1", "expr165", ccsInteger, "", "", $this->antivirus->DataSource->Parameters["expr165"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->encryption->DataSource->Parameters["expr201"] = "22";
   $this->encryption->DataSource->wp = new clsSQLParameters();
   $this->encryption->DataSource->wp->AddParameter("1", "expr201", ccsInteger, "", "", $this->encryption->DataSource->Parameters["expr201"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->app_control->DataSource->Parameters["expr205"] = "23";
   $this->app_control->DataSource->wp = new clsSQLParameters();
   $this->app_control->DataSource->wp->AddParameter("1", "expr205", ccsInteger, "", "", $this->app_control->DataSource->Parameters["expr205"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->mobility->DataSource->Parameters["expr175"] = "14";
   $this->mobility->DataSource->wp = new clsSQLParameters();
   $this->mobility->DataSource->wp->AddParameter("1", "expr175", ccsInteger, "", "", $this->mobility->DataSource->Parameters["expr175"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->datalostprevention->DataSource->Parameters["expr209"] = "24";
   $this->datalostprevention->DataSource->wp = new clsSQLParameters();
   $this->datalostprevention->DataSource->wp->AddParameter("1", "expr209", ccsInteger, "", "", $this->datalostprevention->DataSource->Parameters["expr209"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->networkips->DataSource->Parameters["expr213"] = "25";
   $this->networkips->DataSource->wp = new clsSQLParameters();
   $this->networkips->DataSource->wp->AddParameter("1", "expr213", ccsInteger, "", "", $this->networkips->DataSource->Parameters["expr213"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->networkac->DataSource->Parameters["expr217"] = "26";
   $this->networkac->DataSource->wp = new clsSQLParameters();
   $this->networkac->DataSource->wp->AddParameter("1", "expr217", ccsInteger, "", "", $this->networkac->DataSource->Parameters["expr217"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->wireless_security->DataSource->Parameters["expr221"] = "27";
   $this->wireless_security->DataSource->wp = new clsSQLParameters();
   $this->wireless_security->DataSource->wp->AddParameter("1", "expr221", ccsInteger, "", "", $this->wireless_security->DataSource->Parameters["expr221"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->socialmedia_security->DataSource->Parameters["expr225"] = "28";
   $this->socialmedia_security->DataSource->wp = new clsSQLParameters();
   $this->socialmedia_security->DataSource->wp->AddParameter("1", "expr225", ccsInteger, "", "", $this->socialmedia_security->DataSource->Parameters["expr225"], "", false);
   ...
   $this->contact_maincontact = new clsControl(ccsCheckBox, "contact_maincontact", "contact_maincontact", ccsBoolean, $CCSLocales->GetFormatInfo("BooleanFormat"), CCGetRequestParam("contact_maincontact", $Method, NULL), $this);
   $this->contact_maincontact->CheckedValue = true;
   $this->contact_maincontact->UncheckedValue = false;
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->isp->DataSource->Parameters["expr171"] = "12";
   $this->isp->DataSource->wp = new clsSQLParameters();
   $this->isp->DataSource->wp->AddParameter("1", "expr171", ccsInteger, "", "", $this->isp->DataSource->Parameters["expr171"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->network_monitor->DataSource->Parameters["expr183"] = "18";
   $this->network_monitor->DataSource->wp = new clsSQLParameters();
   $this->network_monitor->DataSource->wp->AddParameter("1", "expr183", ccsInteger, "", "", $this->network_monitor->DataSource->Parameters["expr183"], "", false);
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->networking->DataSource->Parameters["expr233"] = "29";
   $this->networking->DataSource->wp = new clsSQLParameters();
   $this->networking->DataSource->wp->AddParameter("1", "expr233", ccsInteger, "", "", $this->networking->DataSource->Parameters["expr233"], "", false);
   ...
   $this->contact_dob = new clsControl(ccsTextBox, "contact_dob", $CCSLocales->GetText("contact_birthday"), ccsDate, array("mm", "/", "dd", "/", "yyyy"), CCGetRequestParam("contact_dob", $Method, NULL), $this);
   $this->contact_preferred_color = new clsControl(ccsCheckBoxList, "contact_preferred_color", $CCSLocales->GetText("preferredcolor"), ccsText, "", CCGetRequestParam("contact_preferred_color", $Method, NULL), $this);
   $this->contact_preferred_color->Multiple = true;
   $this->contact_preferred_color->DSType = dsTable;
   $this->contact_preferred_color->DataSource = new clsDBdbConnection();
   $this->contact_preferred_color->ds = & $this->contact_preferred_color->DataSource;
   $this->contact_preferred_color->DataSource->SQL = "SELECT * \n" .
"FROM alm_customers_contacts_colors {SQL_Where} {SQL_OrderBy}";
   list($this->contact_preferred_color->BoundColumn, $this->contact_preferred_color->TextColumn, $this->contact_preferred_color->DBFormat) = array("id", "color", "");
   $this->contact_preferred_color->HTML = true;
   $this->contact_hobbies = new clsControl(ccsCheckBoxList, "contact_hobbies", $CCSLocales->GetText("hobbies"), ccsText, "", CCGetRequestParam("contact_hobbies", $Method, NULL), $this);
   $this->contact_hobbies->Multiple = true;
   $this->contact_hobbies->DSType = dsTable;
   $this->contact_hobbies->DataSource = new clsDBdbConnection();
   $this->contact_hobbies->ds = & $this->contact_hobbies->DataSource;
   $this->contact_hobbies->DataSource->SQL = "SELECT * \n" .
"FROM alm_customers_contacts_hobbies {SQL_Where} {SQL_OrderBy}";
   list($this->contact_hobbies->BoundColumn, $this->contact_hobbies->TextColumn, $this->contact_hobbies->DBFormat) = array("id", "hobbies", "");
   $this->contact_hobbies->HTML = true;
   $this->contact_notify_holidays = new clsControl(ccsCheckBoxList, "contact_notify_holidays", $CCSLocales->GetText("notifyholidays"), ccsText, "", CCGetRequestParam("contact_notify_holidays", $Method, NULL), $this);
   $this->contact_notify_holidays->Multiple = true;
   $this->contact_notify_holidays->DSType = dsTable;
   $this->contact_notify_holidays->DataSource = new clsDBdbConnection();
   $this->contact_notify_holidays->ds = & $this->contact_notify_holidays->DataSource;
   $this->contact_notify_holidays->DataSource->SQL = "SELECT * \n" .
"FROM alm_customers_contacts_holidays {SQL_Where} {SQL_OrderBy}";
   list($this->contact_notify_holidays->BoundColumn, $this->contact_notify_holidays->TextColumn, $this->contact_notify_holidays->DBFormat) = array("id", "holidays", "");
   $this->contact_notify_holidays->HTML = true;
...
"FROM alm_evaluation_options {SQL_Where} {SQL_OrderBy}";
   ...
   $this->databases->DataSource->Parameters["expr249"] = "30";
   $this->databases->DataSource->wp = new clsSQLParameters();
   $this->databases->DataSource->wp->AddParameter("1", "expr249", ccsInteger, "", "", $this->databases->DataSource->Parameters["expr249"], "", false);
   ...
   if(!$this->FormSubmitted) {
    if(!is_array($this->city->Value) && !strlen($this->city->Value) && $this->city->Value !== false)
     $this->city->SetText(1);
    if(!is_array($this->contact_maincontact->Value) && !strlen($this->contact_maincontact->Value) && $this->contact_maincontact->Value !== false)
     $this->contact_maincontact->SetValue(false);
   }
  }
 }
//End Class_Initialize Event

//Initialize Method @8-39F12A1B
 function Initialize()
 {
...
//Validate Method @8-02CF4D81
 function Validate()
 {
  ...
  $Validation = ($this->contact_workemail->Validate() && $Validation);
  $Validation = ($this->contact_personalemail->Validate() && $Validation);
  $Validation = ($this->hidcontact_guid->Validate() && $Validation);
  ...
  $Validation = ($this->contact_jobposition->Validate() && $Validation);
  $Validation = ($this->contact_phone->Validate() && $Validation);
  $Validation = ($this->contact_extension->Validate() && $Validation);
  ...
  $Validation = ($this->contact_maincontact->Validate() && $Validation);
  ...
  $Validation = ($this->contact_preferred_color->Validate() && $Validation);
  $Validation = ($this->contact_hobbies->Validate() && $Validation);
  $Validation = ($this->contact_notify_holidays->Validate() && $Validation);
  ...
  $Validation =  $Validation && ($this->contact_workemail->Errors->Count() == 0);
  $Validation =  $Validation && ($this->contact_personalemail->Errors->Count() == 0);
  $Validation =  $Validation && ($this->hidcontact_guid->Errors->Count() == 0);
  ...
  $Validation =  $Validation && ($this->contact_jobposition->Errors->Count() == 0);
  $Validation =  $Validation && ($this->contact_phone->Errors->Count() == 0);
  $Validation =  $Validation && ($this->contact_extension->Errors->Count() == 0);
  ...
  $Validation =  $Validation && ($this->contact_maincontact->Errors->Count() == 0);
  ...
  $Validation =  $Validation && ($this->contact_preferred_color->Errors->Count() == 0);
  $Validation =  $Validation && ($this->contact_hobbies->Errors->Count() == 0);
  $Validation =  $Validation && ($this->contact_notify_holidays->Errors->Count() == 0);
  $Validation =  $Validation && ($this->databases->Errors->Count() == 0);
  return (($this->Errors->Count() == 0) && $Validation);
 }
//End Validate Method

//CheckErrors Method @8-9E8B49FF
 function CheckErrors()
 {
  ...
  $errors = ($errors || $this->contact_workemail->Errors->Count());
  $errors = ($errors || $this->contact_personalemail->Errors->Count());
  $errors = ($errors || $this->hidcontact_guid->Errors->Count());
  ...
  $errors = ($errors || $this->contact_jobposition->Errors->Count());
  $errors = ($errors || $this->contact_phone->Errors->Count());
  $errors = ($errors || $this->contact_extension->Errors->Count());
  ...
  $errors = ($errors || $this->contact_maincontact->Errors->Count());
  ...
  $errors = ($errors || $this->contact_preferred_color->Errors->Count());
  $errors = ($errors || $this->contact_hobbies->Errors->Count());
  $errors = ($errors || $this->contact_notify_holidays->Errors->Count());
...
//Operation Method @8-F33AD4BA
 function Operation()
 {
  ...
  $Redirect = "customers_maint.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
  if($this->Validate()) {
...
//InsertRow Method @8-33C2FD53
 function InsertRow()
 {
  ...
  $this->DataSource->contact_workemail->SetValue($this->contact_workemail->GetValue(true));
  $this->DataSource->contact_personalemail->SetValue($this->contact_personalemail->GetValue(true));
  $this->DataSource->hidcontact_guid->SetValue($this->hidcontact_guid->GetValue(true));
  ...
  $this->DataSource->contact_jobposition->SetValue($this->contact_jobposition->GetValue(true));
  $this->DataSource->contact_phone->SetValue($this->contact_phone->GetValue(true));
  $this->DataSource->contact_extension->SetValue($this->contact_extension->GetValue(true));
  ...
  $this->DataSource->contact_maincontact->SetValue($this->contact_maincontact->GetValue(true));
  ...
  $this->DataSource->contact_preferred_color->SetValue($this->contact_preferred_color->GetValue(true));
  $this->DataSource->contact_hobbies->SetValue($this->contact_hobbies->GetValue(true));
  $this->DataSource->contact_notify_holidays->SetValue($this->contact_notify_holidays->GetValue(true));
...
//Show Method @8-5CF55741
 function Show()
 {
  ...
  $this->contact_jobposition->Prepare();
  ...
  $this->contact_preferred_color->Prepare();
  $this->contact_hobbies->Prepare();
  $this->contact_notify_holidays->Prepare();
  ...
  if($this->FormSubmitted || $this->CheckErrors()) {
   ...
   $Error = ComposeStrings($Error, $this->contact_workemail->Errors->ToString());
   $Error = ComposeStrings($Error, $this->contact_personalemail->Errors->ToString());
   $Error = ComposeStrings($Error, $this->hidcontact_guid->Errors->ToString());
   ...
   $Error = ComposeStrings($Error, $this->contact_jobposition->Errors->ToString());
   $Error = ComposeStrings($Error, $this->contact_phone->Errors->ToString());
   $Error = ComposeStrings($Error, $this->contact_extension->Errors->ToString());
   ...
   $Error = ComposeStrings($Error, $this->contact_maincontact->Errors->ToString());
   ...
   $Error = ComposeStrings($Error, $this->contact_preferred_color->Errors->ToString());
   $Error = ComposeStrings($Error, $this->contact_hobbies->Errors->ToString());
   $Error = ComposeStrings($Error, $this->contact_notify_holidays->Errors->ToString());
  ...
  $this->contact->Show();
  $this->contact_workemail->Show();
  $this->contact_personalemail->Show();
  $this->hidcontact_guid->Show();
  $this->hidtab->Show();
  $this->notes->Show();
  $this->phone->Show();
  $this->address->Show();
  $this->contact_jobposition->Show();
  $this->contact_phone->Show();
  $this->contact_extension->Show();
  ...
  $this->contact_preferred_color->Show();
  $this->contact_hobbies->Show();
  $this->contact_notify_holidays->Show();
  $this->databases->Show();
  $Tpl->parse();
  $Tpl->block_path = $ParentPath;
  $this->DataSource->close();
...
} //End alm_customers Class @8-FCB6E20C
...
//DataSource Variables @8-D5E3067B
 public $Parent = "";
 public $CCSEvents = "";
 public $CCSEventResult;
 public $ErrorBlock;
 ...
 public $contact;
 public $contact_workemail;
 public $contact_personalemail;
 public $hidcontact_guid;
 public $hidtab;
 public $notes;
 public $phone;
 public $address;
 public $contact_jobposition;
 ...
 public $lbreturn;
 public $contact_dob;
 public $contact_preferred_color;
 public $contact_hobbies;
 public $contact_notify_holidays;
 public $databases;
//End DataSource Variables

//DataSourceClass_Initialize Event @8-6C26DE6E
 function clscustomers_maintcontentalm_customersDataSource(& $Parent)
 {
  ...
  $this->contact_workemail = new clsField("contact_workemail", ccsText, "");
  
  $this->contact_personalemail = new clsField("contact_personalemail", ccsText, "");
  
  $this->hidcontact_guid = new clsField("hidcontact_guid", ccsText, "");
  ...
  $this->contact_jobposition = new clsField("contact_jobposition", ccsText, "");
  
  $this->contact_phone = new clsField("contact_phone", ccsText, "");
  
  $this->contact_extension = new clsField("contact_extension", ccsText, "");
  ...
  $this->contact_maincontact = new clsField("contact_maincontact", ccsBoolean, $this->BooleanFormat);
  ...
  $this->contact_preferred_color = new clsField("contact_preferred_color", ccsText, "");
  
  $this->contact_hobbies = new clsField("contact_hobbies", ccsText, "");
  
  $this->contact_notify_holidays = new clsField("contact_notify_holidays", ccsText, "");
...
} //End alm_customersDataSource Class @8-FCB6E20C

class clscustomers_maintcontent { //customers_maintcontent class @1-407CA8C7
...
//Class_Initialize Event @1-22D5EFAC
 function clscustomers_maintcontent($RelativePath, $ComponentName, & $Parent)
 {
  global $CCSLocales;
  global $DefaultDateFormat;
  ...
  $this->Visible = true;
  $this->Parent = & $Parent;
  $this->FileName = "customers_maintcontent.php";
  $this->Redirect = "";
  $this->TemplateFileName = "customers_maintcontent.html";
...
//BindEvents Method @1-A8E9C93F
 function BindEvents()
 {
  $this->alm_customers->os_workstations->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_os_workstations_BeforeShow";
  $this->alm_customers->os_servers->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_os_servers_BeforeShow";
  $this->alm_customers->servers_type->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_servers_type_BeforeShow";
  $this->alm_customers->mailservers->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_mailservers_BeforeShow";
  $this->alm_customers->proxyserver->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_proxyserver_BeforeShow";
  $this->alm_customers->lbgoback->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_lbgoback_BeforeShow";
  $this->alm_customers->content_filter->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_content_filter_BeforeShow";
  $this->alm_customers->branches_connectivity->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_branches_connectivity_BeforeShow";
  $this->alm_customers->branches_bandwidth->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_branches_bandwidth_BeforeShow";
  $this->alm_customers->os_workstations_hw->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_os_workstations_hw_BeforeShow";
  $this->alm_customers->os_servers_hw->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_os_servers_hw_BeforeShow";
  $this->alm_customers->database_security->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_database_security_BeforeShow";
  $this->alm_customers->security_events->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_security_events_BeforeShow";
  $this->alm_customers->changecontrol->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_changecontrol_BeforeShow";
  $this->alm_customers->hidcontact_guid->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_hidcontact_guid_BeforeShow";
  $this->alm_customers->businesspartner->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_businesspartner_BeforeShow";
  $this->alm_customers->virtualization->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_virtualization_BeforeShow";
  $this->alm_customers->email_protection->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_email_protection_BeforeShow";
  $this->alm_customers->vurnerabilities->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_vurnerabilities_BeforeShow";
  $this->alm_customers->firewalls->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_firewalls_BeforeShow";
  $this->alm_customers->backupsystem->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_backupsystem_BeforeShow";
  $this->alm_customers->antivirus->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_antivirus_BeforeShow";
  $this->alm_customers->encryption->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_encryption_BeforeShow";
  $this->alm_customers->app_control->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_app_control_BeforeShow";
  $this->alm_customers->mobility->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_mobility_BeforeShow";
  $this->alm_customers->datalostprevention->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_datalostprevention_BeforeShow";
  $this->alm_customers->networkips->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_networkips_BeforeShow";
  $this->alm_customers->networkac->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_networkac_BeforeShow";
  $this->alm_customers->wireless_security->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_wireless_security_BeforeShow";
  $this->alm_customers->socialmedia_security->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_socialmedia_security_BeforeShow";
  ...
  $this->alm_customers->databases->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_databases_BeforeShow";
  ...
  $this->alm_customers->CCSEvents["AfterUpdate"] = "customers_maintcontent_alm_customers_AfterUpdate";
  $this->alm_customers->CCSEvents["BeforeShow"] = "customers_maintcontent_alm_customers_BeforeShow";
  $this->CCSEvents["BeforeShow"] = "customers_maintcontent_BeforeShow";
...
//Initialize Method @1-E4EE157C
 function Initialize()
 {
  ...
  // Create Components
  $this->alm_customers = new clsRecordcustomers_maintcontentalm_customers($this->RelativePath, $this);
...
//Show Method @1-9EFC1F55
 function Show()
 {
  ...
  $this->Attributes->SetValue("disabled", "");
  $this->Attributes->SetValue("showalert", "");
  $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeShow", $this);
  if(!$this->Visible) {
...
} //End customers_maintcontent Class @1-FCB6E20C

include_once("includes/customers.php");

//Include Event File @1-396C4FB4
include_once(RelativePath . "/customers_maintcontent_events.php");
