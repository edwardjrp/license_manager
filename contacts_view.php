<?php
//Include Common Files @1-DC5B9C33
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "contacts_view.php");
...
//Include Page implementation @11-2082FF0F
include_once(RelativePath . "/contacts_viewcontent.php");
//End Include Page implementation

//Initialize Page @1-01293815
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "contacts_view.html";
$BlockToParse = "main";
...
$contacts_viewcontent = new clscontacts_viewcontent("", "contacts_viewcontent", $MainPage);
$contacts_viewcontent->Initialize();
$MainPage->header = & $header;
$MainPage->sidebar = & $sidebar;
$MainPage->ace_settings = & $ace_settings;
$MainPage->footer = & $footer;
$MainPage->meta_head = & $meta_head;
$MainPage->contacts_viewcontent = & $contacts_viewcontent;
...
//Execute Components @1-B75059F1
$header->Operations();
$sidebar->Operations();
$ace_settings->Operations();
$footer->Operations();
$meta_head->Operations();
$contacts_viewcontent->Operations();
//End Execute Components

//Go to destination page @1-9A50A2A4
if($Redirect)
{
 ...
 unset($meta_head);
 $contacts_viewcontent->Class_Terminate();
 unset($contacts_viewcontent);
 unset($Tpl);
 exit;
}
//End Go to destination page

//Show Page @1-43E6C337
$header->Show();
$sidebar->Show();
$ace_settings->Show();
$footer->Show();
$meta_head->Show();
$contacts_viewcontent->Show();
$Tpl->block_path = "";
