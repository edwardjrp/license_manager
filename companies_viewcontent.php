...
class clsRecordcompanies_viewcontentalm_customers { //alm_customers Class @2-F49DF28E
...
//Class_Initialize Event @2-71B864A7
 function clsRecordcompanies_viewcontentalm_customers($RelativePath, & $Parent)
 {
  ...
  $this->DataSource = new clscompanies_viewcontentalm_customersDataSource($this);
...
//DataSourceClass_Initialize Event @2-1DC357A5
...
class clscompanies_viewcontent { //companies_viewcontent class @1-4D1DA6E2
...
//Class_Initialize Event @1-3EDA5F32
 function clscompanies_viewcontent($RelativePath, $ComponentName, & $Parent)
 {
  global $CCSLocales;
  global $DefaultDateFormat;
  ...
  $this->Visible = true;
  $this->Parent = & $Parent;
  $this->FileName = "companies_viewcontent.php";
  $this->Redirect = "";
  $this->TemplateFileName = "companies_viewcontent.html";
...
//BindEvents Method @1-B30448A6
 function BindEvents()
 {
  $this->alm_customers->lbgoback->CCSEvents["BeforeShow"] = "companies_viewcontent_alm_customers_lbgoback_BeforeShow";
  $this->alm_customers->businesspartner->CCSEvents["BeforeShow"] = "companies_viewcontent_alm_customers_businesspartner_BeforeShow";
  $this->alm_customers->CCSEvents["BeforeInsert"] = "companies_viewcontent_alm_customers_BeforeInsert";
  $this->alm_customers->CCSEvents["AfterInsert"] = "companies_viewcontent_alm_customers_AfterInsert";
  $this->alm_customers->CCSEvents["BeforeUpdate"] = "companies_viewcontent_alm_customers_BeforeUpdate";
  $this->alm_customers->CCSEvents["AfterUpdate"] = "companies_viewcontent_alm_customers_AfterUpdate";
  $this->alm_customers->CCSEvents["BeforeShow"] = "companies_viewcontent_alm_customers_BeforeShow";
  $this->CCSEvents["BeforeShow"] = "companies_viewcontent_BeforeShow";
...
//Initialize Method @1-A759798D
 function Initialize()
 {
  ...
  // Create Components
  $this->alm_customers = new clsRecordcompanies_viewcontentalm_customers($this->RelativePath, $this);
...
} //End companies_viewcontent Class @1-FCB6E20C

//Include Event File @1-E33EDC02
include_once(RelativePath . "/companies_viewcontent_events.php");
