<?php
//Include Common Files @1-29068CA6
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "companies_view.php");
...
//Include Page implementation @7-F6D851BB
include_once(RelativePath . "/companies_viewcontent.php");
//End Include Page implementation

//Initialize Page @1-1C209852
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "companies_view.html";
$BlockToParse = "main";
...
$companies_viewcontent = new clscompanies_viewcontent("", "companies_viewcontent", $MainPage);
$companies_viewcontent->Initialize();
$MainPage->header = & $header;
$MainPage->sidebar = & $sidebar;
$MainPage->ace_settings = & $ace_settings;
$MainPage->footer = & $footer;
$MainPage->meta_head = & $meta_head;
$MainPage->companies_viewcontent = & $companies_viewcontent;
...
//Execute Components @1-F8FAC200
$header->Operations();
$sidebar->Operations();
$ace_settings->Operations();
$footer->Operations();
$meta_head->Operations();
$companies_viewcontent->Operations();
//End Execute Components

//Go to destination page @1-24B420D1
if($Redirect)
{
 ...
 unset($meta_head);
 $companies_viewcontent->Class_Terminate();
 unset($companies_viewcontent);
 unset($Tpl);
 exit;
}
//End Go to destination page

//Show Page @1-4C175554
$header->Show();
$sidebar->Show();
$ace_settings->Show();
$footer->Show();
$meta_head->Show();
$companies_viewcontent->Show();
$Tpl->block_path = "";
