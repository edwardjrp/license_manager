<?php
//Include Common Files @1-12FC48AA
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "globalmaint_maint.php");
...
//Include Page implementation @9-284322D5
include_once(RelativePath . "/globalmaint_maintcontent.php");
//End Include Page implementation

//Initialize Page @1-E7BF7C93
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "globalmaint_maint.html";
$BlockToParse = "main";
...
//Include events file @1-046A1F92
include_once("./globalmaint_maint_events.php");
...
//Execute Components @1-208E253B
$header->Operations();
$sidebar->Operations();
$ace_settings->Operations();
$footer->Operations();
$meta_head->Operations();
$globalmaint_maintcontent->Operations();
//End Execute Components

//Go to destination page @1-89C8AA0C
if($Redirect)
{
 ...
 unset($meta_head);
 $globalmaint_maintcontent->Class_Terminate();
 unset($globalmaint_maintcontent);
 unset($Tpl);
 exit;
}
//End Go to destination page

//Show Page @1-5BE464C6
$header->Show();
$sidebar->Show();
$ace_settings->Show();
$footer->Show();
$meta_head->Show();
$globalmaint_maintcontent->Show();
$lbmodule->Show();
$Tpl->block_path = "";
