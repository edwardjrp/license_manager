...
//licensing_product_displacement_BeforeShow @1-65D51EC5
function licensing_product_displacement_BeforeShow(& $sender)
{
 $licensing_product_displacement_BeforeShow = true;
 $Component = & $sender;
 $Container = & CCGetParentContainer($sender);
 global $licensing_product_displacement; //Compatibility
//End licensing_product_displacement_BeforeShow
	...
	if (strlen($guid) > 0) {
		...
		foreach($allLicenses as $license) {
			...
			foreach($allLicensesPopup as $licensePopup) {
				...
				if (strlen($licensePopup["competitor_product_name"]) > 0 ) {
					$Tpl->setvar("renewlicense_competitor_popup_archived",$licensePopup["competitor_product_name"]);
					$Tpl->setvar("renewlicense_competitordate_popup_archived",$licensePopup["competitor_date"]);
...
//Close licensing_product_displacement_BeforeShow @1-122B8DFF
 return $licensing_product_displacement_BeforeShow;
}
//End Close licensing_product_displacement_BeforeShow
