...
//licensing_archived_tab_BeforeShow @1-50CC9028
function licensing_archived_tab_BeforeShow(& $sender)
{
 $licensing_archived_tab_BeforeShow = true;
 $Component = & $sender;
 $Container = & CCGetParentContainer($sender);
 global $licensing_archived_tab; //Compatibility
//End licensing_archived_tab_BeforeShow
...
//Close licensing_archived_tab_BeforeShow @1-567A344C
 return $licensing_archived_tab_BeforeShow;
}
//End Close licensing_archived_tab_BeforeShow
