<?php
//Include Common Files @1-46277A9A
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "resellers.php");
...
//Include Page implementation @9-F6152BA9
include_once(RelativePath . "/resellers_list.php");
//End Include Page implementation

//Initialize Page @1-25C3D7D3
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "resellers.html";
$BlockToParse = "main";
...
$resellers_list = new clsresellers_list("", "resellers_list", $MainPage);
$resellers_list->Initialize();
$MainPage->header = & $header;
$MainPage->sidebar = & $sidebar;
$MainPage->ace_settings = & $ace_settings;
$MainPage->footer = & $footer;
$MainPage->meta_head = & $meta_head;
$MainPage->resellers_list = & $resellers_list;
...
//Execute Components @1-EC25B949
$header->Operations();
$sidebar->Operations();
$ace_settings->Operations();
$footer->Operations();
$meta_head->Operations();
$resellers_list->Operations();
//End Execute Components

//Go to destination page @1-514B4239
if($Redirect)
{
 ...
 unset($meta_head);
 $resellers_list->Class_Terminate();
 unset($resellers_list);
 unset($Tpl);
 exit;
}
//End Go to destination page

//Show Page @1-0BA1723E
$header->Show();
$sidebar->Show();
$ace_settings->Show();
$footer->Show();
