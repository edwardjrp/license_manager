...
class clsRecordcompanies_listsearch { //search Class @2-49BFC84C
...
//Class_Initialize Event @2-75BC36E1
 function clsRecordcompanies_listsearch($RelativePath, & $Parent)
 {
...
//Operation Method @2-CDA2C9C1
 function Operation()
 {
  ...
  $Redirect = "companies.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
  if($this->Validate()) {
   if($this->PressedButton == "Button_Search") {
    $Redirect = "companies.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_Search", "Button_Search_x", "Button_Search_y")), CCGetQueryString("QueryString", array("s_search", "ccsForm")));
...
class clsGridcompanies_listalm_customers { //alm_customers class @5-EE53132F

//Variables @5-7A0EC289
...
//Class_Initialize Event @5-56F33CF5
 function clsGridcompanies_listalm_customers($RelativePath, & $Parent)
 {
  global $FileName;
  global $CCSLocales;
  global $DefaultDateFormat;
  ...
  $this->Attributes = new clsAttributes($this->ComponentName . ":");
  $this->DataSource = new clscompanies_listalm_customersDataSource($this);
...
} //End alm_customers Class @5-FCB6E20C

class clscompanies_listalm_customersDataSource extends clsDBdbConnection {  //alm_customersDataSource Class @5-76030B0B

//DataSource Variables @5-86E3DA1E
 public $Parent = "";
 public $CCSEvents = "";
 public $CCSEventResult;
 public $ErrorBlock;
...
//DataSourceClass_Initialize Event @5-EE9DC634
 function clscompanies_listalm_customersDataSource(& $Parent)
 {
  $this->Parent = & $Parent;
  $this->ErrorBlock = "Grid alm_customers";
  $this->Initialize();
...
} //End alm_customersDataSource Class @5-FCB6E20C

class clscompanies_list { //companies_list class @1-CCE0A01D
...
//Class_Initialize Event @1-CA6D0958
 function clscompanies_list($RelativePath, $ComponentName, & $Parent)
 {
  global $CCSLocales;
  global $DefaultDateFormat;
  ...
  $this->Visible = true;
  $this->Parent = & $Parent;
  $this->FileName = "companies_list.php";
  $this->Redirect = "";
  $this->TemplateFileName = "companies_list.html";
...
//BindEvents Method @1-3733E807
 function BindEvents()
 {
  $this->alm_customers->alm_customers_TotalRecords->CCSEvents["BeforeShow"] = "companies_list_alm_customers_alm_customers_TotalRecords_BeforeShow";
  $this->alm_customers->custid->CCSEvents["BeforeShow"] = "companies_list_alm_customers_custid_BeforeShow";
  $this->alm_customers->assigned_to->CCSEvents["BeforeShow"] = "companies_list_alm_customers_assigned_to_BeforeShow";
  $this->alm_customers->city->CCSEvents["BeforeShow"] = "companies_list_alm_customers_city_BeforeShow";
  $this->alm_customers->pndeletebutton->CCSEvents["BeforeShow"] = "companies_list_alm_customers_pndeletebutton_BeforeShow";
  $this->alm_customers->CCSEvents["BeforeShowRow"] = "companies_list_alm_customers_BeforeShowRow";
  $this->alm_customers->ds->CCSEvents["BeforeExecuteSelect"] = "companies_list_alm_customers_ds_BeforeExecuteSelect";
  $this->CCSEvents["BeforeShow"] = "companies_list_BeforeShow";
...
//Initialize Method @1-78D825E8
 function Initialize()
 {
  ...
  // Create Components
  $this->search = new clsRecordcompanies_listsearch($this->RelativePath, $this);
  $this->alm_customers = new clsGridcompanies_listalm_customers($this->RelativePath, $this);
...
} //End companies_list Class @1-FCB6E20C

include_once("includes/customers.php");

//Include Event File @1-7BEEFC98
include_once(RelativePath . "/companies_list_events.php");
