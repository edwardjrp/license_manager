...
//Include Page implementation @9-BE0EC2D0
include_once(RelativePath . "/products_list.php");
//End Include Page implementation

//Initialize Page @1-6A89EBDB
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$products_list = new clsproducts_list("", "products_list", $MainPage);
$products_list->Initialize();
$MainPage->header = & $header;
$MainPage->sidebar = & $sidebar;
$MainPage->ace_settings = & $ace_settings;
$MainPage->footer = & $footer;
$MainPage->meta_head = & $meta_head;
$MainPage->products_list = & $products_list;
...
//Execute Components @1-33C73D37
$header->Operations();
$sidebar->Operations();
$ace_settings->Operations();
$footer->Operations();
$meta_head->Operations();
$products_list->Operations();
//End Execute Components

//Go to destination page @1-A31336BD
if($Redirect)
{
