<?php
//Include Common Files @1-D59A9A43
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "globalmaint.php");
...
//Include Page implementation @9-A863E44B
include_once(RelativePath . "/globalmaint_list.php");
//End Include Page implementation

//Initialize Page @1-960C57E3
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "globalmaint.html";
$BlockToParse = "main";
...
$globalmaint_list = new clsglobalmaint_list("", "globalmaint_list", $MainPage);
$globalmaint_list->Initialize();
$MainPage->header = & $header;
$MainPage->sidebar = & $sidebar;
$MainPage->ace_settings = & $ace_settings;
$MainPage->footer = & $footer;
$MainPage->meta_head = & $meta_head;
$MainPage->globalmaint_list = & $globalmaint_list;
...
//Execute Components @1-2D671D2D
$header->Operations();
$sidebar->Operations();
$ace_settings->Operations();
$footer->Operations();
$meta_head->Operations();
$globalmaint_list->Operations();
//End Execute Components

//Go to destination page @1-1A092179
if($Redirect)
{
 ...
 unset($meta_head);
 $globalmaint_list->Class_Terminate();
 unset($globalmaint_list);
 unset($Tpl);
 exit;
}
//End Go to destination page

//Show Page @1-FE34F1B0
$header->Show();
$sidebar->Show();
$ace_settings->Show();
$footer->Show();
$meta_head->Show();
$globalmaint_list->Show();
$Tpl->block_path = "";
