<?php
//Include Common Files @1-0F1A2CAC
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "licensing_customers.php");
...
//Include Page implementation @10-784F0AB7
include_once(RelativePath . "/licensing_customerscontent.php");
//End Include Page implementation

//Initialize Page @1-0E39F41A
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "licensing_customers.html";
$BlockToParse = "main";
...
$licensing_customerscontent = new clslicensing_customerscontent("", "licensing_customerscontent", $MainPage);
$licensing_customerscontent->Initialize();
$MainPage->header = & $header;
$MainPage->sidebar = & $sidebar;
$MainPage->ace_settings = & $ace_settings;
$MainPage->footer = & $footer;
$MainPage->meta_head = & $meta_head;
$MainPage->licensing_customerscontent = & $licensing_customerscontent;
...
//Execute Components @1-E37422D2
$header->Operations();
$sidebar->Operations();
$ace_settings->Operations();
$footer->Operations();
$meta_head->Operations();
$licensing_customerscontent->Operations();
//End Execute Components

//Go to destination page @1-A3679B87
if($Redirect)
{
 ...
 unset($meta_head);
 $licensing_customerscontent->Class_Terminate();
 unset($licensing_customerscontent);
 unset($Tpl);
 exit;
}
//End Go to destination page

//Show Page @1-F7022979
$header->Show();
$sidebar->Show();
$ace_settings->Show();
$footer->Show();
$meta_head->Show();
$licensing_customerscontent->Show();
$Tpl->block_path = "";
