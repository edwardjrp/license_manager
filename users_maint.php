...
//Include Page implementation @7-898E0CCC
include_once(RelativePath . "/users_maintcontent.php");
//End Include Page implementation

//Initialize Page @1-2FF784F3
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$users_maintcontent = new clsusers_maintcontent("", "users_maintcontent", $MainPage);
$users_maintcontent->Initialize();
$MainPage->header = & $header;
$MainPage->sidebar = & $sidebar;
$MainPage->ace_settings = & $ace_settings;
$MainPage->footer = & $footer;
$MainPage->meta_head = & $meta_head;
$MainPage->users_maintcontent = & $users_maintcontent;
...
//Execute Components @1-8F3B644E
$header->Operations();
$sidebar->Operations();
$ace_settings->Operations();
$footer->Operations();
$meta_head->Operations();
$users_maintcontent->Operations();
//End Execute Components

//Go to destination page @1-789D33F3
if($Redirect)
{
    ...
    unset($meta_head);
    $users_maintcontent->Class_Terminate();
    unset($users_maintcontent);
    unset($Tpl);
    exit;
}
//End Go to destination page

//Show Page @1-05538D7D
$header->Show();
$sidebar->Show();
$ace_settings->Show();
$footer->Show();
$meta_head->Show();
$users_maintcontent->Show();
$Tpl->block_path = "";
