<?php
//Include Common Files @1-75411C4D
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "settings.php");
...
//Include Page implementation @8-2B260FBD
include_once(RelativePath . "/settings_list.php");
//End Include Page implementation

//Initialize Page @1-D318B63C
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$settings_list = new clssettings_list("", "settings_list", $MainPage);
$settings_list->Initialize();
$MainPage->header = & $header;
$MainPage->sidebar = & $sidebar;
$MainPage->ace_settings = & $ace_settings;
$MainPage->footer = & $footer;
$MainPage->meta_head = & $meta_head;
$MainPage->settings_list = & $settings_list;
...
//Execute Components @1-27FA592D
$header->Operations();
$sidebar->Operations();
$ace_settings->Operations();
$footer->Operations();
$meta_head->Operations();
$settings_list->Operations();
//End Execute Components

//Go to destination page @1-EB05732E
if($Redirect)
{
