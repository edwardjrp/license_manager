...
//Class_Initialize Event @2-398DA237
...
"FROM alm_customers_contacts_holidays {SQL_Where} {SQL_OrderBy}";
   ...
   if(!$this->FormSubmitted) {
    ...
    if(!is_array($this->allow_notifications->Value) && !strlen($this->allow_notifications->Value) && $this->allow_notifications->Value !== false)
     $this->allow_notifications->SetValue(true);
   }
  }
 }
...
//DataSource Variables @2-360B659D
 public $Parent = "";
 public $CCSEvents = "";
 public $CCSEventResult;
 public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-70BDCB09
