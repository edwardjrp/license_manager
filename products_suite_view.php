<?php
//Include Common Files @1-7628231A
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "products_suite_view.php");
...
//Include Page implementation @10-49BF34F8
include_once(RelativePath . "/products_suite_viewcontent.php");
//End Include Page implementation

//Initialize Page @1-37E5E84A
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "products_suite_view.html";
$BlockToParse = "main";
...
$products_suite_viewcontent = new clsproducts_suite_viewcontent("", "products_suite_viewcontent", $MainPage);
$products_suite_viewcontent->Initialize();
$MainPage->header = & $header;
$MainPage->sidebar = & $sidebar;
$MainPage->ace_settings = & $ace_settings;
$MainPage->footer = & $footer;
$MainPage->meta_head = & $meta_head;
$MainPage->products_suite_viewcontent = & $products_suite_viewcontent;
...
//Execute Components @1-6246A4B3
$header->Operations();
$sidebar->Operations();
$ace_settings->Operations();
$footer->Operations();
$meta_head->Operations();
$products_suite_viewcontent->Operations();
//End Execute Components

//Go to destination page @1-C7273CAA
if($Redirect)
{
 ...
 unset($meta_head);
 $products_suite_viewcontent->Class_Terminate();
 unset($products_suite_viewcontent);
 unset($Tpl);
 exit;
}
//End Go to destination page

//Show Page @1-044845C6
$header->Show();
$sidebar->Show();
$ace_settings->Show();
$footer->Show();
$meta_head->Show();
$products_suite_viewcontent->Show();
$Tpl->block_path = "";
