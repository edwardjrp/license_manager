<?php
//Include Common Files @1-93D6AD83
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "licensing_viewfile.php");
...
//Include Page implementation @11-1047F44A
include_once(RelativePath . "/licensing_viewfilecontent.php");
//End Include Page implementation

//Initialize Page @1-6DF1BCA2
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "licensing_viewfile.html";
$BlockToParse = "main";
...
//Include events file @1-B818FDD5
include_once("./licensing_viewfile_events.php");
...
//Execute Components @1-7422F71E
$header->Operations();
$sidebar->Operations();
$ace_settings->Operations();
$footer->Operations();
$meta_head->Operations();
$licensing_viewfilecontent->Operations();
//End Execute Components

//Go to destination page @1-F3FA9DE6
if($Redirect)
{
 ...
 unset($meta_head);
 $licensing_viewfilecontent->Class_Terminate();
 unset($licensing_viewfilecontent);
 unset($Tpl);
 exit;
}
//End Go to destination page

//Show Page @1-C37A76B9
$header->Show();
$sidebar->Show();
$ace_settings->Show();
$footer->Show();
$meta_head->Show();
$licensing_viewfilecontent->Show();
$lbparams->Show();
$Tpl->block_path = "";
