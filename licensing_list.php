<?php
class clsRecordlicensing_listsearch { //search Class @2-CDC4496D
...
//Class_Initialize Event @2-4EC5F20C
 function clsRecordlicensing_listsearch($RelativePath, & $Parent)
 {
...
//Operation Method @2-5671EB0D
 function Operation()
 {
  ...
  $Redirect = "licensing.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
  if($this->Validate()) {
   if($this->PressedButton == "Button_Search") {
    $Redirect = "licensing.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_Search", "Button_Search_x", "Button_Search_y")), CCGetQueryString("QueryString", array("s_search", "ccsForm")));
...
class clsGridlicensing_listalm_customers { //alm_customers class @8-BE4C16C8

//Variables @8-7A0EC289
...
//Class_Initialize Event @8-A875D56F
 function clsGridlicensing_listalm_customers($RelativePath, & $Parent)
 {
  global $FileName;
  global $CCSLocales;
  global $DefaultDateFormat;
  ...
  $this->Attributes = new clsAttributes($this->ComponentName . ":");
  $this->DataSource = new clslicensing_listalm_customersDataSource($this);
...
class clslicensing_listalm_customersDataSource extends clsDBdbConnection {  //alm_customersDataSource Class @8-E87F0CDF

//DataSource Variables @8-86E3DA1E
 public $Parent = "";
 public $CCSEvents = "";
 public $CCSEventResult;
 public $ErrorBlock;
...
//DataSourceClass_Initialize Event @8-6FB29383
 function clslicensing_listalm_customersDataSource(& $Parent)
 {
  $this->Parent = & $Parent;
  $this->ErrorBlock = "Grid alm_customers";
  $this->Initialize();
...
class clslicensing_list { //licensing_list class @1-81A4E47F
...
//Class_Initialize Event @1-3EDD304B
 function clslicensing_list($RelativePath, $ComponentName, & $Parent)
 {
  global $CCSLocales;
  global $DefaultDateFormat;
  ...
  $this->Visible = true;
  $this->Parent = & $Parent;
  $this->FileName = "licensing_list.php";
  $this->Redirect = "";
  $this->TemplateFileName = "licensing_list.html";
...
//BindEvents Method @1-03F25BF0
 function BindEvents()
 {
  $this->alm_customers->alm_customers_TotalRecords->CCSEvents["BeforeShow"] = "licensing_list_alm_customers_alm_customers_TotalRecords_BeforeShow";
  $this->alm_customers->custid->CCSEvents["BeforeShow"] = "licensing_list_alm_customers_custid_BeforeShow";
  $this->alm_customers->assigned_to->CCSEvents["BeforeShow"] = "licensing_list_alm_customers_assigned_to_BeforeShow";
  $this->alm_customers->city->CCSEvents["BeforeShow"] = "licensing_list_alm_customers_city_BeforeShow";
  $this->alm_customers->CCSEvents["BeforeShowRow"] = "licensing_list_alm_customers_BeforeShowRow";
  $this->alm_customers->ds->CCSEvents["BeforeExecuteSelect"] = "licensing_list_alm_customers_ds_BeforeExecuteSelect";
...
//Initialize Method @1-BB043396
 function Initialize()
 {
  ...
  // Create Components
  $this->search = new clsRecordlicensing_listsearch($this->RelativePath, $this);
  $this->alm_customers = new clsGridlicensing_listalm_customers($this->RelativePath, $this);
...
} //End licensing_list Class @1-FCB6E20C

//Include Event File @1-2BF1F97F
include_once(RelativePath . "/licensing_list_events.php");
