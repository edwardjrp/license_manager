<?php
//Include Common Files @1-888FE89E
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "companies.php");
...
//Include Page implementation @11-EBCCB3BF
include_once(RelativePath . "/companies_list.php");
//End Include Page implementation

//Initialize Page @1-A24D0ABE
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$companies_list = new clscompanies_list("", "companies_list", $MainPage);
$companies_list->Initialize();
$MainPage->header = & $header;
$MainPage->sidebar = & $sidebar;
$MainPage->ace_settings = & $ace_settings;
$MainPage->footer = & $footer;
$MainPage->meta_head = & $meta_head;
$MainPage->companies_list = & $companies_list;
...
//Execute Components @1-2797A76A
$header->Operations();
$sidebar->Operations();
$ace_settings->Operations();
$footer->Operations();
$meta_head->Operations();
$companies_list->Operations();
//End Execute Components

//Go to destination page @1-B367EB62
if($Redirect)
{
 ...
 unset($meta_head);
 $companies_list->Class_Terminate();
 unset($companies_list);
 unset($Tpl);
 exit;
}
//End Go to destination page

//Show Page @1-7FB03899
$header->Show();
$sidebar->Show();
$ace_settings->Show();
$footer->Show();
