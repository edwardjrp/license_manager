...
//Class_Initialize Event @2-E35A02BB
...
//InsertRow Method @2-CA528F3A
 function InsertRow()
 {
  ...
  $this->DataSource->lbgroup->SetValue($this->lbgroup->GetValue(true));
  $this->DataSource->suite_code->SetValue($this->suite_code->GetValue(true));
  $this->DataSource->suite_name->SetValue($this->suite_name->GetValue(true));
...
//DataSource Variables @2-D4816FC1
 public $Parent = "";
 public $CCSEvents = "";
 public $CCSEventResult;
 public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-DD9CB01B
 function clsproducts_suite_maintcontentalm_product_suitesDataSource(& $Parent)
 {
  ...
  $this->InsertFields["id_group"] = array("Name" => "id_group", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
  $this->InsertFields["suite_code"] = array("Name" => "suite_code", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
  $this->InsertFields["suite_name"] = array("Name" => "suite_name", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
  ...
  $this->UpdateFields["id_group"] = array("Name" => "id_group", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
  $this->UpdateFields["suite_code"] = array("Name" => "suite_code", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
  $this->UpdateFields["suite_name"] = array("Name" => "suite_name", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
...
//Insert Method @2-B2A3A5D0
 function Insert()
 {
  ...
  $this->InsertFields["id_group"]["Value"] = $this->lbgroup->GetDBValue(true);
  $this->InsertFields["suite_code"]["Value"] = $this->suite_code->GetDBValue(true);
  $this->InsertFields["suite_name"]["Value"] = $this->suite_name->GetDBValue(true);
...
//Update Method @2-2A2C030F
 function Update()
 {
  ...
  $this->UpdateFields["id_group"]["Value"] = $this->lbgroup->GetDBValue(true);
  $this->UpdateFields["suite_code"]["Value"] = $this->suite_code->GetDBValue(true);
  $this->UpdateFields["suite_name"]["Value"] = $this->suite_name->GetDBValue(true);
